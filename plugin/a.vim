...
call <SID>AddAlternateExtensionMapping('CXX',"H")
" Mappings for golang, swith between golang source files and golang test files
call <SID>AddAlternateExtensionMapping('go',"go")

" Setup default search path, unless the user has specified
" a path in their [._]vimrc. 
if (!exists('g:alternateSearchPath') || g:alternateSearchPath == '')
...
function! EnumerateFilesByExtension(path, baseName, extension)
   ...
   if (extSpec != "") 
      ...
      while (!done)
         ...
         if (ext != "")
            let newFilename = GetNewFilename(a:path, a:baseName, a:extension, ext)
            if (enumeration == "")
...
" Function : GetNewFilename(PRIVATE)
" Purpose  : get the corresponding filename to switch.
"            Some program languages do not identify different file types with
"            suffix (E.g golang source file source.go and test file
"            source_test.go). We can do this different part in this function
" Args     : path -- path of a file (not including the file)
"            baseName -- base name of the file
"            extension -- extension of the file
"            corrispondingExtession -- corresponding extension of the file
